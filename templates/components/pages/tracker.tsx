...
export function Tracker() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('financeTrackerExpenses', JSON.stringify(expensesData));
    localStorage.setItem('financeTrackerIncome', JSON.stringify(incomeData));

    // Dispatch custom event for same-page updates
    window.dispatchEvent(new Event('financialDataUpdate'));
  }, [expenses, income]);
